...
public class BaseTest
{
    ...
    public void securetunnel() throws Exception{
        Process p = Runtime.getRuntime().exec(System.getProperty("user.dir")+"/SecureTunnel/cbt-tunnels-macos --username smitha.vijayakumar%40in.pega.com --authkey udbb51c6e48ebd0b");
        Thread.sleep(10000);
    }
